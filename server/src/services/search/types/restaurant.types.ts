...
export interface RestaurantResult {
  ...
  /** Google business_status when present (OPERATIONAL, CLOSED_TEMPORARILY; CLOSED_PERMANENTLY never returned) */
  businessStatus?: string;
  /** Set to TEMP_CLOSED when businessStatus is CLOSED_TEMPORARILY so UI can label */
