 ...
 * 
 * These types represent business concepts independent of:
 * - How data is transported (API contracts)
 * - How data is stored (internal state)
 * - Implementation details (service interfaces)
 * 
 * Shared across all layers (API, services, UI)
 * Changes here affect business rules - proceed with care
 */
...
export interface ClarificationChoice {
  ...
  constraintPatch: Partial<import('./api-contracts.types.js').SearchParams>; // Constraints to apply if chosen
}
