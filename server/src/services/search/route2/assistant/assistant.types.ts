...
export const AssistantOutputSchema = z.object({
  ...
  language: z.enum(['he', 'en', 'ar', 'ru', 'fr', 'es', 'other']).optional(), // Language of the generated message (assistantLanguage) - backward compat
  outputLanguage: z.enum(['he', 'en', 'ar', 'ru', 'fr', 'es', 'other']).optional() // LANGUAGE_ENFORCEMENT: Output language for validation
}).strict();
...
export const ASSISTANT_JSON_SCHEMA = {
  ...
  properties: {
    ...
    language: { type: 'string', enum: ['he', 'en', 'ar', 'ru', 'fr', 'es', 'other'] },
    outputLanguage: { type: 'string', enum: ['he', 'en', 'ar', 'ru', 'fr', 'es', 'other'] }
  },
